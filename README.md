# AhsanID — Portfolio Mohammad Ahsan Al Ghoni

Portofolio pribadi **Mohammad Ahsan Al Ghoni** — pelajar dari Gresik yang membangun
backend, game realtime, aplikasi edukasi, dan platform streaming web publik.
...
- **Tanpa framework** — HTML5 semantik + CSS3 + vanilla JavaScript
...
16 sertifikat kompetensi IT dari:
- **Dicoding** (4 sertifikat) — AI, Cloud & Gen AI di AWS, JavaScript, Backend
...
Site ini cocok untuk GitHub Pages, Cloudflare Pages, Netlify, Vercel, atau hosting statis lainnya. Tidak perlu build step.

```bash
# Build: tidak diperlukan
# Deploy: upload semua file ke root domain
```
...
© 2025–2026 Mohammad Ahsan Al Ghoni · Gresik, Indonesia
